    ...
    <body>
        <header class="bg-white shadow-md py-4">
            <div class="container mx-auto px-4 flex justify-between items-center">
                <a href="/" wire:naviagte='/' class="text-xl font-bold text-indigo-600">InvoiceGen</a>
                <nav>
                    <a href="/register" wire:navigate='/register' class="text-sm bg-red-600 text-white px-4 py-2 rounded hover:bg-red-500">Logout</a>
                </nav>
            </div>
        </header>
        <div class="">
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
             ...
             <div class="grid grid-cols-4">
                <aside id="default-sidebar" class="sm:mt-10   left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                    <div class="h-full px-3 overflow-y-auto bg-white shadow-lg">
                       <ul class="space-y-2 font-medium">
                          <li>
                             <a href="/dashboard" wire:navigate='/dashboard' class=" {{ Route::is('dashboard') ? 'text-blue-700 bg-blue-100' : 'text-gray-900 hover:bg-gray-100' }} flex items-center p-2 text-black rounded-lg hover:bg-gray-100 group">
